...
void System::SetStatus(int status) {
  mpTracker->mState = (enum Tracking::eTrackingState)status;
}

bool System::GetRobotPos(cv::Mat &Rcw, cv::Mat  &Ow)
{
    return mpTracker->GetRobotPos(Rcw, Ow);
}
...
/*
void System::setGlobalMap(costmap_2d::Costmap2D_HRG *globalMap)

{
    pGlobal_map = globalMap;
}

void System::setLocalMap(costmap_2d::Costmap2D_HRG *localMap)
